package com.blur.communicationservice.exception;
...
public enum ErrorCode {
    ...
    YOU_ARE_NOT_ALLOWED(6004, "Youre not allowed", HttpStatus.BAD_REQUEST),
    ...
    NOTIFICATION_NOT_FOUND(7003, "Notification not found", HttpStatus.INTERNAL_SERVER_ERROR),
    ;
