...
public class AuthController {
  ...
  ApiResponse<com.blur.common.dto.response.IntrospectResponse> introspect(@RequestBody IntrospectRequest introspecRequest)
      throws ParseException, JOSEException {
    var result = authenticationService.introspect(introspecRequest);
    return ApiResponse.<com.blur.common.dto.response.IntrospectResponse>builder().result(result).build();
  }
