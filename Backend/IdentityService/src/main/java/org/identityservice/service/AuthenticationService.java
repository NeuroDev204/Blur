...
public class AuthenticationService {
  ...
  public AuthResponse authenticate(AuthRequest authRequest) {
    ...
    if (!authenticated) {
      throw new BlurException(ErrorCode.INVALID_USERNAME_OR_PASSWORD);
    }
  ...
  public com.blur.common.dto.response.IntrospectResponse introspect(IntrospectRequest introspecRequest) throws JOSEException, ParseException {
    ...
    return com.blur.common.dto.response.IntrospectResponse.builder()
